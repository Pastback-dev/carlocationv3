      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              Our intelligent recommendation engine analyzes your preferences to match you with the ideal vehicle
              from today's market.
            </motion.p>
          ...
          >
            ...
            >
              ...
              <img src={heroCar} alt="Premium car" className="w-full h-auto rounded-3xl shadow-2xl" />
